...
export default class Details extends Component{
   ...
   test1= async()=>{
    ...
    render() {
      ...
      //   const detailsURI = 'https://maps.googleapis.com/maps/api/place/nearbysearch/json?location= 7.957192399999999,80.7600266&radius=100000&types=place_of_worship&key=AIzaSyB83SfaccVha2jO_M3UD9_ly5x7I2nbMpo';      
      //   axios.get(detailsURI)
      //   .then(res => {
      //     console.log('DisplaySuggest');
      //     //Alert.alert(JSON.stringify(res));
      //     this.state.nearPlace=res.data.results;
      //     //console.log(objx)
      //     Alert.alert(res);
      //   })
      //   .catch(error=>{
      ...
      //   return(
      //     <View style={{backgroundColor:'#fff', borderRadius:30, width:338, height:200}}>
      //       <ScrollView horizontal={true}>
      //         <View style={{backgroundColor:'gray', borderRadius:30, width:168, height:170, marginLeft:15,marginTop:15}}>
